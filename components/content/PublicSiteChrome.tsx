  ...
  return (
    <footer className="border-t border-[#2A4B3C]/15 bg-[#EDE5D6] bg-paper-dark">
      <div className="mx-auto max-w-5xl px-5 pt-12">
        ...
        <div className="animate-enter mb-10 flex items-center justify-between">
          ...
          <nav aria-label="公开内容导航" className="flex items-center gap-4 whitespace-nowrap text-base text-[#2A4B3C]/60 sm:gap-5">
            <Link href="/tools/ashtanga-practice-tracker" className="transition-colors hover:text-[#98783E]">记录工具</Link>
            <Link href="/ashtanga" className="transition-colors hover:text-[#98783E]">阿斯汤加</Link>
            <Link href="/authors/shao-bingbing" className="transition-colors hover:text-[#98783E]">关于作者</Link>
          </nav>
        ...
        <div className="border-t border-[#2A4B3C]/10 pb-12 pt-8">
          <div className="grid gap-8 sm:grid-cols-[1fr_auto] sm:items-center">
            <div>
              <p className="max-w-lg text-sm leading-7 text-[#2A4B3C]/65">
                给阿斯汤加练习者的安静记录工具，也分享入门科普与个人感悟。
              </p>
              <Link
                href="/practice"
                className="mt-5 inline-flex min-h-10 items-center justify-center border border-[#2A4B3C] px-7 py-2 text-xs tracking-[0.08em] text-[#203D31] transition-all hover:bg-[#203D31] hover:text-[#F9F7F2]"
              >
                开始练习
              </Link>
            </div>
            <div className="flex items-center gap-3">
              ...
              />
              <p className="max-w-28 text-[10px] leading-5 text-[#2A4B3C]/55">
                微信扫码或长按识别<br />阿斯汤加-熬汤日记
              </p>
            </div>
          </div>
        </div>

        <div className="border-t border-[#2A4B3C]/8 py-5 text-[10px] tracking-[0.18em] text-[#2A4B3C]/28">
