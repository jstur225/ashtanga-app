      ...
      <div>
        ...
        <div className="relative">
          <textarea
            ...
            rows={5}
            className="w-full px-4 py-3 pr-14 rounded-2xl bg-secondary text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all resize-none font-serif text-sm"
          />
          {/* 照片上传按钮 - 位于输入框右下方 */}
