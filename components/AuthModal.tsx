      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            className="fixed bottom-0 left-0 right-0 w-full min-w-full bg-white rounded-t-[24px] z-[60] p-6 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] max-h-[calc(100vh-2rem)] overflow-y-auto relative"
          >
