    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="text-center flex-1">
          ...
          <div className="text-[10px] text-muted-foreground font-serif mt-1">分钟</div>
        </div>
        <div className="text-center flex-1">
          <div className="text-2xl font-serif text-primary">{stats.avgMinutes}</div>
          <div className="text-[10px] text-muted-foreground font-serif mt-1">平均</div>
        </div>
        <div className="text-center flex-1">
          <div className="text-2xl font-serif text-orange-500">{stats.consecutiveWeeks}</div>
          <div className="text-[10px] text-muted-foreground font-serif mt-1">连续(周)</div>
        </div>
      </div>
    </div>
  )
