...
- [x] 照片上传限制与友好提示已完成：免费 10MB / Pro 30MB；全量 Vitest 49 文件 / 539 项通过
...
## 2026-06-24 - 照片上传限制：免费 10MB / 付费 30MB ✅ 已完成
...
- [x] `__tests__/oss-utils.test.ts` — 覆盖免费 10MB、Pro 30MB 与友好错误文案
